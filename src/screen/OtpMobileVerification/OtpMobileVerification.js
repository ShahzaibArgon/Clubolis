...
import { BOTTOMTAB, OTPEMAILVERIFICATION } from "../../constants/Navigation";
    ...
    return (
        <SafeAreaView
            ...
            >
                ...
                <Image
                    resizeMode={'contain'}
                    source={IMAGES.mobileVerification}
                ...
                <Text style={[styles.secondDesciptionTextStyle, { textDecorationLine: 'underline' }]}>{'+61********'}</Text>
